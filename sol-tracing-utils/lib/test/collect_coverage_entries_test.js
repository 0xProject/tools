...
const collect_coverage_entries_1 = require("../src/collect_coverage_entries");
...
describe('Collect coverage entries', () => {
    describe('#collectCoverageEntries', () => {
        it('correctly collects coverage entries for Simplest contract', () => {
            ...
            const coverageEntries = collect_coverage_entries_1.collectCoverageEntries(simplestContract);
        ...
        it('correctly collects coverage entries for SimpleStorage contract', () => {
            ...
            const simpleStorageContractFileName = path.resolve(__dirname, 'fixtures/contracts', simpleStorageContractBaseName);
            const simpleStorageContract = fs.readFileSync(simpleStorageContractFileName).toString();
            const coverageEntries = collect_coverage_entries_1.collectCoverageEntries(simpleStorageContract);
        ...
        it('correctly ignores all coverage entries for Ignore contract', () => {
            ...
            const solcovIgnoreContractFileName = path.resolve(__dirname, 'fixtures/contracts', solcovIgnoreContractBaseName);
            ...
            const coverageEntries = collect_coverage_entries_1.collectCoverageEntries(solcovIgnoreContract, IGNORE_REGEXP);
            const fnIds = _.keys(coverageEntries.fnMap);
