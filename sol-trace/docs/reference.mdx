...
*Inherited from [RevertTraceSubprovider](#interface-reverttracesubprovider).[emitPayloadAsync](#emitpayloadasync)*
...
*Inherited from [RevertTraceSubprovider](#interface-reverttracesubprovider).[handleRequest](#handlerequest)*
...
*Inherited from [RevertTraceSubprovider](#interface-reverttracesubprovider).[setEngine](#setengine)*
...
*Inherited from [RevertTraceSubprovider](#interface-reverttracesubprovider).[start](#start)*
...
*Inherited from [RevertTraceSubprovider](#interface-reverttracesubprovider).[stop](#stop)*
