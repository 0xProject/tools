...
export declare class LedgerSubprovider extends BaseWalletSubprovider {
     ...
     */
    getAccountsAsync(numberOfAccounts?: number, startingIndex?: number): Promise<string[]>;
    /**
     ...
     */
    getAccountAsync(accountIndex?: number): Promise<string>;
    /**
