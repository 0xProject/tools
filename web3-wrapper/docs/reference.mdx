...
**Returns:** *Partial‹[CallTxDataBaseRPC](#interface-calltxdatabaserpc)›*
...
**Returns:** *Partial‹[CallDataRPC](#interface-calldatarpc)›*

marshalled call data

####  marshalCallOverrides
...
Name | Type | Description |
------ | ------ | ------ |
`overrides` | GethCallOverrides | overrides to marshal |

**Returns:** *[GethCallOverridesRPC](#interface-gethcalloverridesrpc)*

marshalled overrides
...
**Returns:** *Partial‹[TxDataRPC](#interface-txdatarpc)›*
