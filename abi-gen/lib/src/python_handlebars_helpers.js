...
exports.registerPythonHelpers = void 0;
 ...
 */
function registerPythonHelpers() {
    Handlebars.registerHelper('equal', (lhs, rhs) => {
        return lhs === rhs;
    });
    Handlebars.registerHelper('safeString', (str) => new Handlebars.SafeString(str));
    Handlebars.registerHelper('parameterType', utils_1.utils.solTypeToPyType.bind(utils_1.utils));
    Handlebars.registerHelper('returnType', utils_1.utils.solTypeToPyType.bind(utils_1.utils));
...
exports.registerPythonHelpers = registerPythonHelpers;
function solValueToPyValue(pythonVariable, abiItem) {
    const pythonTypeName = utils_1.utils.solTypeToPyType(abiItem);
    if (pythonTypeName.match(/List\[.*\]/) !== null) {
        return `[${solValueToPyValue('element', Object.assign(Object.assign({}, abiItem), { type: abiItem.type.replace('[]', '') }))} for element in ${pythonVariable}]`;
    }
    else {
...
//# sourceMappingURL=python_handlebars_helpers.js.map