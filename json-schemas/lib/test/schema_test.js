...
describe('Schema', () => {
    ...
    describe('#tokenSchema', () => {
        ...
        it('should fail for invalid token', () => {
            const num = 4;
            const testCases = [
                Object.assign(Object.assign({}, token), { address: null }),
                Object.assign(Object.assign({}, token), { decimals: undefined }),
                [],
                num,
            ];
            const shouldFail = true;
    ...
    describe('order including schemas', () => {
        ...
        describe('#orderSchema', () => {
            ...
            it('should fail for invalid order', () => {
                const testCases = [
                    Object.assign(Object.assign({}, order), { salt: undefined }),
                    Object.assign(Object.assign({}, order), { salt: 'salt' }),
                    'order',
                ];
                const shouldFail = true;
        ...
        describe('signed order including schemas', () => {
            const signedOrder = Object.assign(Object.assign({}, order), { signature: '0x031b61a3ed31b43c8780e905a260a35faefcc527be7516aa11c0256729b5b351bc3340349190569279751135161d22529dc25add4f6069af05be04cacbda2ace2254' });
            ...
            describe('#signedOrderSchema', () => {
                ...
                it('should fail for invalid signed order', () => {
                    const testCases = [
                        Object.assign(Object.assign({}, signedOrder), { signature: undefined }),
                    ];
                    const shouldFail = true;
            ...
            describe('#orderFillOrKillRequestsSchema', () => {
                ...
                it('should fail for invalid order fill or kill requests', () => {
                    const testCases = [
                        [
                            Object.assign(Object.assign({}, orderFillOrKillRequests[0]), { fillTakerAmount: undefined }),
                        ],
                    ];
                    const shouldFail = true;
            ...
            describe('#orderCancellationRequestsSchema', () => {
                ...
                it('should fail for invalid order cancellation requests', () => {
                    const testCases = [
                        [
                            Object.assign(Object.assign({}, orderCancellationRequests[0]), { takerTokenCancelAmount: undefined }),
                        ],
                    ];
                    const shouldFail = true;
            ...
            describe('#orderFillRequestsSchema', () => {
                ...
                it('should fail for invalid order fill requests', () => {
                    const testCases = [
                        [
                            Object.assign(Object.assign({}, orderFillRequests[0]), { takerTokenFillAmount: undefined }),
                        ],
                    ];
                    const shouldFail = true;
