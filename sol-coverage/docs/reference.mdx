...
*Inherited from [CoverageSubprovider](#interface-coveragesubprovider).[emitPayloadAsync](#emitpayloadasync)*
...
*Inherited from [CoverageSubprovider](#interface-coveragesubprovider).[handleRequest](#handlerequest)*
...
*Inherited from [CoverageSubprovider](#interface-coveragesubprovider).[setEngine](#setengine)*
...
*Inherited from [CoverageSubprovider](#interface-coveragesubprovider).[start](#start)*
...
*Inherited from [CoverageSubprovider](#interface-coveragesubprovider).[stop](#stop)*
